...
# deploy DB Profile
aws cloudformation package --template-file -template-dynamodb.yml --output-template-file out-template-dynamodb.yml --s3-bucket profile-hello-deploy
aws cloudformation deploy --template-file out-template-dynamodb.yml --stack-name abdelhamid-profile-dynamodb
rm out-template-dynamodb.yml

# Lambda + API Profile
aws cloudformation package --template-file template-api.yml --output-template-file out-template-api.yml --s3-bucket profile-hello-deploy
aws cloudformation deploy --template-file out-template-api.yml --stack-name abdelhamid-profile --parameter-overrides DynamoDBStack=abdelhamid-profile-dynamodb --capabilities CAPABILITY_IAM
rm out-template-api.yml